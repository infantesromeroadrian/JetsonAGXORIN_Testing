#!/usr/bin/env python3
"""
Sistema de monitoreo de recursos del sistema para benchmarks de LLM
Captura métricas de CPU, GPU, RAM, temperatura durante las ejecuciones
"""
...
class SystemMonitor:
    """Monitor continuo de recursos del sistema"""
...
# Funciones de conveniencia para usar con los scripts existentes
